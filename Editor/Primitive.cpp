...
// ------------------------------------------------------------
Primitive::Primitive() : transform(glm::mat4(1.0f)),/* color(White),*/ wire(false), axis(false), type(PrimitiveTypes::Primitive_Point)
{}
...
{
	transform = glm::rotate(transform, glm::radians(angle), u);
}
...
void Cylinder::InnerRender() const
{
	...
	{
		float a = i * pi<float>() / 180; // degrees to radians
