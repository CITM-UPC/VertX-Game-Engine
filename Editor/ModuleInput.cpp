...
{
	OutputDebugString("EDITOR: Init SDL input event system\n");
	...
	{
		OutputDebugString("EDITOR: SDL_EVENTS could not initialize!\n");
...
{
	OutputDebugString("EDITOR: Quitting SDL input event subsystem-----\n");
